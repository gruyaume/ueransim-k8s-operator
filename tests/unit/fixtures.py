...
from charm import UERANSIMCharm
...
class GNBSUMUnitTestFixtures:
    ...
    patcher_n2_requirer_amf_ip_address = patch(
        "charm.N2Requires.amf_ip_address", new_callable=PropertyMock
    )
    ...
    def setup(self, request):
        ...
        self.mock_n2_requirer_amf_ip_address = (
            GNBSUMUnitTestFixtures.patcher_n2_requirer_amf_ip_address.start()
        )
